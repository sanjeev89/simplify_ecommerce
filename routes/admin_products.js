                ...
                product.save(function (err) {
                    ...
                    mkdirp('public/product_images/' + product._id + '/gallery/thumbs').then(made =>{
                                ...
                                if (imageFile != "") {
                                    ...
                                    // console.log("I am image file ", imageFile)
...
router.post('/product-gallery/:id', function(req, res) {
    ...
    productImage.mv(path, function(err) {
        ...
        //resizing images and storing to thumbs
        resizeImg(fs.readFileSync(path), {width: 100, height: 100})
        .then(function(buf) {
            //console.log("I am buf ", buf) //buf is image
            fs.writeFileSync(thumbsPath, buf)  //will write resized images to thumbspath
        });
...
router.get('/delete-product/:id', isAdmin, function(req, res) {
    ...
    fs.remove('public/product_images/' + req.params.id, function(err) {
        if(err) {
            return console.log(err)
        }
        
        //find and elete product
